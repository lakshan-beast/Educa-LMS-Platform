...
//   // 👑 🔐 [THE EXCLUSIVE MULTI-USER FACULTY IDENTIFIER]:
//   // දැනට ලොග් වෙලා ඉන්න ගුරුවරයාගේ නිල විෂය මෙතනින් ඔටෝම හඳුනා ගනී මචං! (Default එක MATHS) [INDEX 4]
...
//     // 📡 [STRICT SUBJECT PRIVACY STREAM]:
//     // සර්වර් මට්ටමෙන්ම තමන්ගේ විෂයට අදාළ (maths / science / english) නිවේදන විතරක් ලයිව් ඇද ගනී! [INDEX 51]
//     const q = query(
//       collection(db, "class_notices"),
...
//       },
//       (err) => {
//         console.error("Cloud Notice Stream Error:", err);
//         setIsLoading(false);
//       },
//     );
...
//   // 🚀 SUBMIT NEW NOTICE TO CLOUD
//   // const handleAddNotice = async (e) => {
//   //   e.preventDefault();
//   //   if (!noticeForm.title || !noticeForm.text) return alert("Please fill all required fields!");

//   //   try {
//   //     // 👑 🔐 [THE DYNAMIC SUBJECT WRITER]:
//   //     // "maths" වෙනුවට දැනට ලොග් වී ඉන්න සර්ගේ සැබෑ විෂය (facultyFieldLock) අනුව ක්ලවුඩ් එකේ ලියවේ මචං! [INDEX 4, 51]
...
//   //     setNoticeForm({ title: "", text: "", grade: "11", type: "General", author: currentFacultySubject + " Faculty Sir" });
//   //   } catch (err) {
...
//             {/* 👑 🎛️ THE EXCLUSIVE GRADE SELECTOR DROPDOWN */}
//             <div className="form-field">
//               <label>Target Academic Grade</label>
//               <select
//                 value={formData.grade}
//                 // onChange={(e) =>
//                 //   setNoticeForm({ ...noticeForm, grade: e.target.value })
//                 // }
//                 onChange={handleInputChange}
//                 className="form-dropdown-control">
...
//         <div className="admin-notice-feed">
//           <h3>Active Published Notices</h3>

//           {isLoading ? (
//             <div className="feed-loading">
//               🔄 Fetching Live Cloud Announcements...
//             </div>
//           ) : notices.length === 0 ? (
//             <div className="feed-empty">
//               No active notices found inside the repository.
//             </div>
//           ) : (
//             <div className="admin-notice-scroll-list">
//               {notices.map((item) => (
//                 <div key={item.docId} className="admin-notice-card">
...
//                       className="delete-action-trigger"
//                       title="Delete Notice">
//                       <FaTrashCan />
//                     </button>
//                   </div>
