...
export default ClassScheduleVault; */}
      ...
      {/* DISPLAY SIDE (LIVE CARD DATA MATRIX) */}
      {/* <div className="schedule-content live-preview-panel">
        <h4>Live Schedule Status Overview</h4> */}
      {/* දත්ත ලෝඩ් වෙනකම් පෙන්වන Loading එක */}
      {/* {isLoading ? (
    <div className="vault-loading">Streaming Active Schedule Nodes...</div>
  ) : !currentSchedule ? (
    <div className="vault-empty">
      🔒 No schedule record deployed for Grade {localGrade} {subject?.toUpperCase()} yet.
    </div>
  ) : ( */}
      {/* <div
          ...
          <div
            ...
            <span style={{ color: "#ffd700", fontWeight: "bold" }}>
              {currentSchedule.classNames}
            </span>
            <small style={{ color: "#8b949e" }}>
              ⏰ {currentSchedule.weekPicker}
            </small>
          </div>
      ...
      {/* schedule-form END */}
      {/* 🔔 AUTOMATED AUTO-DISMISS NOTIFICATION TOASTS */}
      {/* <NotificationToast
        message={success}
        type="success"
        onClose={() => setSuccess("")}
      ...
      <div className="schedule-content live-preview-panel">
        ...
        {/* {isLoading ? (
          <div className="vault-loading">
            Streaming Active Schedule Nodes...
          </div>
        ) : !currentSchedule ? (
          <div className="vault-empty">
            🔒 No schedule record deployed for Grade {localGrade}{" "}
            {subject?.toUpperCase() || ""} yet.
          </div>
        ) : ( */}
        <div
          className="secure-schedule-preview-card"
